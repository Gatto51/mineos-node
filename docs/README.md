...
The [MineOS Turnkey ISO](https://drive.usercontent.google.com/download?id=1HUIiD8ymILiWKxlm3v6RmUfIss6q7iYG&export=download&authuser=0) is approximately 700MB and supports x86_64 architectures only. 
